...
function LandingPage() {
    return (
       ...
       <span className="top_button" style={{height: "50px", 
        ...
        <p>InfoNav is a platform that help you get your information powored by AI chat with our model today for free.
        ...
        <span>
        <img src= "https://images.unsplash.com/photo-1464226184884-fa280b87c399?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="ai" style={{ height: '250px', width: '350px', marginTop: '50px', borderRadius: '5px'}}></img>
        </span>
        <span>
        <img src= "https://images.unsplash.com/photo-1509100194014-d49809396daa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="ai" style={{ height: '250px', width: '350px', marginTop: '50px', borderRadius: '5px'}}></img>
        </span>
        <span style={{ marginRight: '20px'}}>
        <img src= "https://images.unsplash.com/photo-1535275226173-7ee8b465f0c1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="my-2 w-24 h-24 object-contain mix-blend-darken"  style={{ height: '250px', width: '350px', marginTop: '50px' , borderRadius: '5px'}}></img>
        </span>
        <span style={{ marginRight: '20px'}}>
        <img src= "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="my-2 w-24 h-24 object-contain mix-blend-darken"  style={{ height: '250px', width: '350px', marginTop: '50px', borderRadius: '5px'}}></img>
        </span>
        </section>
        </p>
        </article>
